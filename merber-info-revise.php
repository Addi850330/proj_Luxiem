...
<?php include __DIR__ . '/parts/html-head.php' ?>
    ...
    <link rel="stylesheet" href="./css/merber-info-revise.css">
    <link rel="stylesheet" href="./css/merber-info-revise-rwd.css">
...
<div class="side_nav_wrap">
        ...
        <div class="container">
            <form class="info-revise" action="">
                <table class="mc-link">
                    <tr>
                        <td class="ir"><a href="./merber-info-revise.php">資料修改</a></td>
                        <td class="pr"><a href="./merber-password-revise.php">密碼修改</a></td>
                    </tr>
                </table>
                <div class="ir-img">
                    <svg class="mc-logo" width="70" height="70" viewBox="0 0 50 49" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <p class="sign-up-text">ID暱稱</p>
                <div class="Icon-inside">
                    <i class="fa-regular fa-user"></i>
                    <input name="nameID" type="email" placeholder="Allen" class="box" required>
                </div>
                <p class="sign-up-text-hint">-</p>
                <p class="sign-up-text">E-mail帳號</p>
                <div class="Icon-inside">
                    <i class="fa-regular fa-envelope"></i>
                    <input name="password" type="password" placeholder="Andy123@gmail.com" class="box" required>
                </div>
                <p class="sign-up-text-hint">-</p>
                <p class="sign-up-text">手機號碼</p>
                <div class="Icon-inside">
                    <i class="fa-solid fa-mobile-screen-button"></i>
                    <input name="password" type="password" placeholder="0912123123" class="box" required>
                </div>
                <p class="sign-up-text-hint">-</p>
                <p class="sign-up-text">確認修改密碼</p>
                <div class="Icon-inside">
                ...
                <p class="sign-up-text-hint">-</p>
                <div>
                    <input type="submit" value="修改" class="mc-btn" style="font-size: 20px;">
                </div>
            </form>
