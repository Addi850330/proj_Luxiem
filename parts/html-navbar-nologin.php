...
<body>
            ...
            <div class="desktop-user">
                <div class="desktop-user-nav">
                    <a class="user-info" href="#">
                        <div class="user-imgwrap" style="border:1px solid black ;">
                            <img src="./imgs/Navbar/nouser.png" alt="">
                        </div>
                        <div class="user-name"></div>
                        <div class="user-login">登入</div>
                        <div class="log-icon">
    ...
    <div class="mobile-menu">
        <a class="user-info" href="#">
            <div class="user-imgwrap" style="border: 1px solid rgba(211, 180, 114, 0);">
                <img src="./imgs/Navbar/nouser.png" alt="">
            </div>
            <div class="user-name"></div>
            <div class="user-login">登入</div>
